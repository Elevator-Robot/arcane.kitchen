        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-green-700/30">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-semibold text-gradient gothic-text">
                  𝔄𝔯𝔠𝔞𝔫𝔢 𝔎𝔦𝔱𝔠𝔥𝔢𝔫
                </span>
              </div>
              <button
          ...
          <div className="flex-1 overflow-y-auto px-4">
            <div className="space-y-2">
              <h3 className="text-sm font-medium text-green-300 px-2 mb-3 gothic-text">
              ...
              {isAuthenticated ? (
                <div className="space-y-1">
                  ...
                  <div className="text-center py-8">
                    <svg
                      className="w-12 h-12 text-green-700 mx-auto mb-3"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <p className="text-green-400 text-sm">
                      Thy grimoire is empty
                    </p>
                    <p className="text-green-600 text-xs mt-1">
                      Begin thy mystical journey to fill these pages
                    </p>
                  </div>
                </div>
              ) : (
                <div className="text-center py-8">
                  <svg
                    className="w-12 h-12 text-amber-700 mx-auto mb-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-amber-400 text-sm">
                    Join the coven to preserve thy wisdom
                  </p>
                  <p className="text-amber-600 text-xs mt-1">
                    Sacred knowledge shall be recorded here
                  </p>
                </div>
              )}
            </div>
