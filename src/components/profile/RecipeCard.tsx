...
export default function RecipeCard({ recipe, onOptions, onClick }: Props) {
  return (
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100 text-xs text-gray-600">
          <div className="flex items-center gap-4">
            ...
            <span className="flex items-center gap-1"><Heart className="w-4 h-4 text-rose-500" /> {recipe.saves ?? 0}</span>
          </div>
