  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'magic-gradient':
          'linear-gradient(135deg, rgba(76, 29, 149, 0.9), rgba(5, 150, 105, 0.8))',
        'potion-gradient':
          'linear-gradient(135deg, rgba(76, 29, 149, 0.9), rgba(34, 197, 94, 0.8), rgba(217, 119, 6, 0.7))',
        'poison-gradient':
          'linear-gradient(135deg, rgba(6, 78, 59, 0.9), rgba(34, 197, 94, 0.8))',
        'cauldron-gradient':
          'radial-gradient(ellipse at center, rgba(31, 41, 55, 0.9), rgba(17, 24, 39, 1))',
        'mystical-smoke':
      ...
      boxShadow: {
        magical:
          '0 4px 20px -2px rgba(76, 29, 149, 0.25), 0 0 8px rgba(168, 85, 247, 0.2)',
        potion:
          '0 4px 20px -2px rgba(34, 197, 94, 0.25), 0 0 12px rgba(34, 197, 94, 0.15)',
        poison:
          '0 4px 20px -2px rgba(6, 78, 59, 0.3), 0 0 15px rgba(34, 197, 94, 0.2)',
        cauldron:
          'inset 0 2px 4px rgba(0, 0, 0, 0.3), 0 4px 8px rgba(0, 0, 0, 0.2)',
        'recipe-card':
          '0 4px 8px rgba(0, 0, 0, 0.1), 0 1px 3px rgba(76, 29, 149, 0.1)',
        'recipe-hover':
          '0 8px 25px rgba(76, 29, 149, 0.2), 0 4px 10px rgba(168, 85, 247, 0.15)',
        'mystical-glow':
      ...
      keyframes: {
        'magical-glow': {
          ...
          '50%': {
            boxShadow:
              '0 0 20px rgba(168, 85, 247, 0.8), 0 0 30px rgba(168, 85, 247, 0.5)',
